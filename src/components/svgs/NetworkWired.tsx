...
const NetworkWired = ({ color = "currentColor", size }: SVGProps) => (
  <svg
  ...
  >
    <g fill={color} color="#000" fontFamily="sans-serif" fontWeight={400}>
      ...
      <path
        fillRule="evenodd"
        d="M3.5 7c-.667 0-1.138.408-1.322.777C1.993 8.147 2 8.5 2 8.5v2h1v-2s.007-.147.072-.277C3.138 8.092 3.167 8 3.5 8h8c.333 0 .362.092.428.223.065.13.072.277.072.277v2h1v-2s.007-.353-.178-.723A1.485 1.485 0 0 0 11.5 7z"
        overflow="visible"
        style={{
          lineHeight: "normal",
          fontVariantLigatures: "normal",
      ...
      <path
        fillRule="evenodd"
        d="m7.006 4.498-.006 3 1 .004.006-3z"
        overflow="visible"
        style={{
          lineHeight: "normal",
          fontVariantLigatures: "normal",
